export class Matrix4 {
    ...
    public static invert(m: Matrix4): Matrix4 {
        ...
        temp[0] = m._matrix[5]  * m._matrix[10] * m._matrix[15] - 
             m._matrix[5]  * m._matrix[11] * m._matrix[14] - 
             m._matrix[9]  * m._matrix[6]  * m._matrix[15] + 
             m.matrix[9]  * m.matrix[7]  * m.matrix[14] +
             m.matrix[13] * m.matrix[6]  * m.matrix[11] - 
             m.matrix[13] * m.matrix[7]  * m.matrix[10];
        temp[4] = -m.matrix[4]  * m.matrix[10] * m.matrix[15] + 
        ...
        temp[8] = m.matrix[4]  * m.matrix[9] * m.matrix[15] - 
        ...
        temp[12] = -m.matrix[4]  * m.matrix[9] * m.matrix[14] + 
        ...
        let det = m.matrix[0] * temp[0] + m.matrix[1] * temp[4] + m.matrix[2] * temp[8] + m.matrix[3] * temp[12];
        if (det === 0) {
            return m;
        }
        temp[1] = -m.matrix[1]  * m.matrix[10] * m.matrix[15] + 
        ...
        temp[2] = m.matrix[1]  * m.matrix[6] * m.matrix[15] - 
        ...
        temp[3] = -m.matrix[1] * m.matrix[6] * m.matrix[11] + 
        ...
        temp[5] = m.matrix[0]  * m.matrix[10] * m.matrix[15] - 
        ...
        temp[6] = -m.matrix[0]  * m.matrix[6] * m.matrix[15] + 
        ...
        temp[7] = m.matrix[0] * m.matrix[6] * m.matrix[11] - 
        ...
        temp[9] = -m.matrix[0]  * m.matrix[9] * m.matrix[15] + 
        ...
        temp[10] = m.matrix[0]  * m.matrix[5] * m.matrix[15] - 
        ...
        temp[11] = -m.matrix[0] * m.matrix[5] * m.matrix[11] + 
        ...
        temp[13] = m.matrix[0]  * m.matrix[9] * m.matrix[14] - 
        ...
        temp[14] = -m.matrix[0]  * m.matrix[5] * m.matrix[14] + 
        ...
        temp[15] = m.matrix[0] * m.matrix[5] * m.matrix[10] - 
