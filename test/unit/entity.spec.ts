...
describe("Entity unit testing", () => {
    ...
    describe("Empty Entity object", () => {
        ...
        it("should be set to 0,0 coordinates", () => {
            expect(go1.transform).toEqual({x: 0, y: 0});
        });
        it("should have no components", () => {
            expect(go1.components).toBeInstanceOf("array");
            expect(go1.components).toBe([]);
        });
        it("should have no children", () => {
            expect(go1.children).toBeInstanceOf("array");
            expect(go1.components).toBe([]);
        });
    ...
    describe("Entity object with tag", () => {
        ...
        it("should be set to 0,0 coordinates", () => {
            expect(go2.transform).toEqual({x: 0, y: 0});
        });
        it("should have no components", () => {
            expect(go2.components).toBeInstanceOf("array");
            expect(go2.components).toBe([]);
        });
        it("should have no children", () => {
            expect(go2.children).toBeInstanceOf("array");
            expect(go2.components).toBe([]);
        });
    });
    describe("Entity object with tag and new coordinates", () => {
        ...
        it("should be set to 11,23 coordinates", () => {
            expect(go3.transform).toEqual({x: 11, y: 23});
        });
        it("should have no components", () => {
            expect(go3.components).toBeInstanceOf("array");
            expect(go3.components).toBe([]);
        });
        it("should have no children", () => {
            expect(go3.children).toBeInstanceOf("array");
            expect(go3.components).toBe([]);
        });
    });
    describe("Entity object with tag, new coordinates, and 1 component", () => {
        ...
        it("should be set to 30,-10 coordinates", () => {
            expect(go4.transform).toEqual({x: 30, y: -10});
        });
        it("should have a component", () => {
            expect(go4.components).toBeInstanceOf("array");
            expect(go4.components).toBe([]);
        });
        it("should be a flag component", () => {
            expect(go4.hasComponent("FlagComponent")).toBe(true);
        });
        it("should have no children", () => {
            expect(go4.children).toBeInstanceOf("array");
            expect(go4.components).toBe([]);
        });
    });
